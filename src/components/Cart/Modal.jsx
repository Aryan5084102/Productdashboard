                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <button onClick={() => { buyNow(); closeModal() }} type="button" className="focus:outline-none w-full text-white bg-[#0B7A74] hover:bg-[#0B7A74]  outline-0 font-medium rounded-lg text-sm px-5 py-2.5 ">Pay Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
